...
commands:
  ...
  # MY GROWTH Operations
  - name: mygrowth-rebuild
    visibility: [full, quick, key]
    description: 'Build + restart PM2 do MY GROWTH com verificação de saúde. Ex: *mygrowth-rebuild'

  - name: add-menu
    visibility: [full, quick]
    args: '{nome} {rota} {icone}'
    description: 'Adicionar item ao menu lateral do MY GROWTH (Sidebar.tsx + rebuild). Ex: *add-menu Seleção /selecao Target'
