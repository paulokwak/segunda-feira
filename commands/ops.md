...
tool_stack:
  ...
  infra_tech:
    - VPS YOUR_VPS_IP (MY GROWTH / automações)
...
incident_severity:
  P1_critico:
    definition: 'Serviço down para cliente ou aluno (MY GROWTH off, ASAAS inacessível, acesso bloqueado)'
...
commands:
  ...
  - name: onboarding-cliente
    visibility: [full, quick, key]
    args: '{cliente}'
    description: 'Checklist e guia completo de onboarding para novo cliente. Ex: *onboarding-cliente cliente-x'
  ...
  - name: entrega-cliente
    ...
    description: 'Checklist de entrega de projeto ou relatório para cliente. Ex: *entrega-cliente cliente-x relatorio-mensal-marco'
...
- **CEO:** Diretriz operacional e prioridades do negócio
...
- Cliente X — cliente de consultoria (onboarding, entregas mensais, offboarding)
